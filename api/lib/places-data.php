...
function fis_places_dataset(): array
{
    static $places = [
        ...
        ['name' => 'ชุมพร', 'name_en' => 'Chumphon', 'province' => 'จังหวัดชุมพร', 'lat' => 10.4957, 'lon' => 99.1797, 'kind' => 'province', 'coast' => 'gulf'],
        ['name' => 'ทุ่งตะโก', 'name_en' => 'Thung Tako', 'province' => 'จังหวัดชุมพร', 'lat' => 10.1102, 'lon' => 99.0831, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ท่าแซะ', 'name_en' => 'Tha Sae', 'province' => 'จังหวัดชุมพร', 'lat' => 10.6646, 'lon' => 99.1728, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ปะทิว', 'name_en' => 'Pathio', 'province' => 'จังหวัดชุมพร', 'lat' => 10.7091, 'lon' => 99.3182, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ละแม', 'name_en' => 'Lamae', 'province' => 'จังหวัดชุมพร', 'lat' => 9.7679, 'lon' => 99.0926, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'สวี', 'name_en' => 'Sawi', 'province' => 'จังหวัดชุมพร', 'lat' => 10.2367, 'lon' => 99.1094, 'kind' => 'district', 'coast' => 'gulf'],
        ...
        ['name' => 'ระนอง', 'name_en' => 'Ranong', 'province' => 'จังหวัดระนอง', 'lat' => 9.9658, 'lon' => 98.6348, 'kind' => 'province', 'coast' => 'andaman'],
        ['name' => 'กะเปอร์', 'name_en' => 'Papoe', 'province' => 'จังหวัดระนอง', 'lat' => 9.5852, 'lon' => 98.5961, 'kind' => 'district', 'coast' => 'andaman'],
        ['name' => 'ละอุ่น', 'name_en' => 'La-Un', 'province' => 'จังหวัดระนอง', 'lat' => 10.1165, 'lon' => 98.7500, 'kind' => 'district', 'coast' => 'andaman'],
        ['name' => 'สุขสำราญ', 'name_en' => 'Suk Samran', 'province' => 'จังหวัดระนอง', 'lat' => 9.3446, 'lon' => 98.4290, 'kind' => 'district', 'coast' => 'andaman'],
        ...
        ['name' => 'สุราษฎร์ธานี', 'name_en' => 'Surat Thani', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.1401, 'lon' => 99.3331, 'kind' => 'province', 'coast' => 'gulf'],
        ['name' => 'กาญจนดิษฐ์', 'name_en' => 'Kanchanadit', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.1661, 'lon' => 99.4701, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ดอนสัก', 'name_en' => 'Don Sak', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.3168, 'lon' => 99.6918, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ท่าฉาง', 'name_en' => 'Tha Chang', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.2642, 'lon' => 99.1922, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ท่าชนะ', 'name_en' => 'Tha Chana', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.5720, 'lon' => 99.1659, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'เกาะพะงัน', 'name_en' => 'Ko Pha-Ngan', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.7195, 'lon' => 99.9951, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'เกาะสมุย', 'name_en' => 'Ko Samui', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.5357, 'lon' => 99.9357, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'ไชยา', 'name_en' => 'Chaiya', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 9.3863, 'lon' => 99.1986, 'kind' => 'district', 'coast' => 'gulf'],
        ['name' => 'เกาะเต่า', 'name_en' => '', 'province' => 'จังหวัดสุราษฎร์ธานี', 'lat' => 10.0981, 'lon' => 99.8381, 'kind' => 'landmark', 'coast' => 'gulf'],
    ];
