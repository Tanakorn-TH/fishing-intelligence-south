...
| ชนิดปลา ถิ่นอาศัย ขนาด อุณหภูมิที่ชอบ | FishBase v24.07 | **CC BY-NC 4.0** |
| ชื่อไทย ชื่อท้องถิ่น สถานภาพ | กรมประมง ผ่าน data.go.th | CC BY |
| ชื่อไทยเสริม | วิกิพีเดียภาษาไทย | CC BY-SA 4.0 |
| รูปปลา | Wikimedia Commons · iNaturalist | ดูรายภาพในไฟล์ข้อมูล |

Solunar และข้างขึ้นข้างแรมคำนวณเองในระบบตาม Meeus *Astronomical Algorithms* ไม่ได้ดึงจากที่ไหน

> ⚠️ **FishBase เป็นแหล่งเดียวในตารางที่เป็น CC BY-NC คือห้ามใช้เชิงพาณิชย์**
> fishing.yru.ac.th เป็นเว็บมหาวิทยาลัยจึงใช้ได้ ถ้าโครงการนี้จะหารายได้เมื่อใด
> ต้องติดต่อทีม FishBase ก่อน — ดู [docs/species-registry.md](docs/species-registry.md)
...
- [x] ระเบียนปลาไทยที่ตกได้ 469 ชนิด แยกตามสภาพน้ำ ([docs/species-registry.md](docs/species-registry.md))
- [ ] หน้าแสดงระเบียนปลา และจับคู่กับอุณหภูมิน้ำที่หมาย
